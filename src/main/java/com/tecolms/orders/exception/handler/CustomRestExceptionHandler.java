package com.tecolms.orders.exception.handler;
...
import com.tecolms.orders.constant.OrderBaseConstant;
import com.tecolms.orders.exception.apierror.ApiError;
import com.tecolms.orders.exception.custom.CustomValidationViolationException;
import com.tecolms.orders.exception.custom.ResourceNotFoundException;
import com.tecolms.orders.exception.custom.VendorMasterBusinessException;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleCustomValidationViolationException(CustomValidationViolationException ex) {
		...
		apiError.setMessage(OrderBaseConstant.VALIDATION_ERROR);
	...
	@ExceptionHandler(VendorMasterBusinessException.class)
	protected ResponseEntity<Object> handleVendorMasterException(VendorMasterBusinessException ex,
